...
describe('Test product endpoint responses', function () {
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    sql = "DELETE FROM users WHERE lastname = 'Ayman' ";
    ...
    it('post to DB', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.post('/product').set('Authorization', "Bearer " + token).send(theProduct)];
                case 1:
                    response = _a.sent();
    ...
    it('index route for products', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
