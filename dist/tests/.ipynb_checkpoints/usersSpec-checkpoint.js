...
it('create method should add a user', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, theUser.create({
                    //id: '1',
                    firstName: 'Mohamed',
                    lastName: 'Ayman',
                    password: '123',
            ...
            case 1:
                ...
                expect(result).toEqual({
                    ...
                    firstName: 'Mohamed',
                    //lastName: 'Ayman',
                    //password: bcrypt_1.default.hashSync('123' + pepper, parseInt(saltRounds))
                });
                return [2 /*return*/];
        }
    });
...
it('index method should return a list of users', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, theUser.Index()];
            case 1:
                result = _a.sent();
...
it('show method should return the correct user', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, theUser.show('5')];
            case 1:
                result = _a.sent();
                expect(result).toBeDefined();
                return [2 /*return*/];
