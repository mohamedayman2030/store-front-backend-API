...
describe('test db of orders', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var theOrder, theUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    theOrder = new Order_1.orders();
                    theUser = new User_1.usersStore();
                    return [4 /*yield*/, theUser.create({
                            id: '1',
                            firstName: 'Mohamed',
                            lastName: 'Ahmed',
                            password: '123'
    ...
    it('create method should add order', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, theOrder.create({
                        id: '1',
                        status: 'complete',
                        userID: '1',
                    })];
    ...
    it('show method should return the correct order', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, theOrder.show('1')];
                case 1:
                    result = _a.sent();
                    expect(result).toBeDefined();
                    return [2 /*return*/];
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    sql = "DELETE FROM Users WHERE lastName = 'Ahmed' ";
                    ;
