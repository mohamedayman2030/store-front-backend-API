...
describe('test user endpoint responses', function () {
    it("create user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.post('/users').send(theUser)];
                case 1:
                    response = _a.sent();
    ...
    it('show route for users', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/users/3')];
                case 1:
                    response = _a.sent();
                    expect(response.body.firstname).toEqual('Mohamed');
                    return [2 /*return*/];
