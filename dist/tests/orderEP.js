...
describe('test order endpoints', function () {
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    sql = "DELETE FROM users WHERE firstname = 'Mohamed' ";
    ...
    it('create new order', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.post('/orders').send(theorder)];
                case 1:
                    res = _a.sent();
    ...
    it('show the last order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/orders/1').set('Authorization', "Bearer " + token)];
                case 1:
                    response = _a.sent();
